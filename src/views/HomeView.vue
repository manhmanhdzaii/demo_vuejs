<template>
    ...
    <!-- <div class="content_main">
      <div class="ct_main_box">
        ...
        <div class="main_content">
          From high to low, classic or modern, we have covered. Check out the
          hottest men's outfits of 2022. Find your own style and let us help you
          make it happen.
        </div>
  ...
  <div class="main_box">
    <div class="main_box1">
      <div class="m_box1_left">
        ...
        <div class="m_box1_left_title">LOOKBOOK FOR MEN</div>
        ...
        <div class="m_box1_left_view">VIEW OUR PRODUCT</div>
      </div>
      <div class="m_box1_right">
        <img src="../assets/images/gr_1.png" class="img_b1_right_before" />
        <img src="../assets/images/id_3.png" class="img_b1_right_after" />
        <img src="../assets/images/id_2.png" class="img_b1_right_after" />
      </div>
    </div>
    <div class="main_box2">
      <div class="m_box2_title">FEATURED PRODUCTS</div>
      <div class="m_box2_content">
        Wanna shine with the most outstanding outfits? Let’s see our featured
  ...
  <div class="main_box">
    <div class="main_box4">
      <div class="m_box2_title">BEST SELLER</div>
      <div class="m_box2_content">
  ...
  <div class="main_box5">
    <img src="../assets/images/home_box5.png" />
    <div class="m_sub_box5">
      <div class="m_sub_box5_title">Our Mission</div>
      <div class="m_sub_box5_content">
        ...
        array of styles that is fit for the fashion loving people. From workwear
        to street style, night out, Fashion store can keep you going from
        day-to-night. Shop the latest collection from Fashion clothing line,
        ranging in dresses to tops, backpacks, rompers, pants, outerwear,
        watches and shoes.
      </div>
      <a href="#">
        <div class="m_sub_box5_link">READ MORE</div>
      </a>
    </div>
  </div>
  <div class="main_box6">
    <img src="../assets/images/b6_logo1.png" />
    <img src="../assets/images/b6_logo2.png" />
    <img src="../assets/images/b6_logo3.png" />
    <img src="../assets/images/b6_logo4.png" />
  </div>
</template>
...
.m_box1_left_head span,
.m_box1_left_head {
  font-family: "Oxygen";
  font-weight: 300;
  font-size: 20px;
  color: rgba(43, 47, 50, 0.8);
  margin-bottom: 22px;
}
.m_box1_left_head span {
  border-bottom: 1.5px solid #2b2f32;
  padding-bottom: 10px;
}
.m_box1_left_title {
  font-weight: 700;
...
@media screen and (max-width: 500px) {
  ...
  .m_box1_right img:nth-child(2) {
    width: 100%;
    height: 415px;
    margin-top: 40px;
  }
  .m_box1_right img:nth-child(3) {
    width: 100%;
    height: 272px;
  }
  .m_box2_item {
